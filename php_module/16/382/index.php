...
<table border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table  border="0" cellpadding="0" cellspacing="1">
	  ...
	  <tr>
        <td width="101" height="20" bgcolor="#FFFFFF"><div align="center">注册手机号：</div></td>
        <td width="347" height="20" bgcolor="#FFFFFF"><div align="left"><input type="text" name="regtel" size="25" class="inputcss"></div></td>
      </tr>
	  <tr>
      ...
      <tr>
        ...
        <td height="20" bgcolor="#FFFFFF"><div align="left"><input type="text" name="tel" size="25" class="inputcss"></div></td>
      </tr>
      <tr>
        <td height="80" bgcolor="#FFFFFF"><div align="center">短信内容：</div></td>
        <td height="80" bgcolor="#FFFFFF"><div align="left">
          <textarea name="mess" cols="52" rows="6" class="inputcss"></textarea>
