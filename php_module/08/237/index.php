     ...
     <form  name="form1" method="post" action="index.php">
	  <tr>
        <td bgcolor="#A6C2DE"><div align="center">&nbsp;
          <input type="submit" name="submit" value="合并学生信息" class="buttoncss">
        </div></td>
      </tr>
	  </form>
    </table></td>
...
<table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#679D66"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="79" height="25" bgcolor="#A6C2DE"><div align="center" class="STYLE1">学号</div>          <div align="center" class="STYLE1"></div>          <div align="center" class="STYLE1"></div>          <div align="center" class="STYLE1"></div></td>
        <td width="80" bgcolor="#A6C2DE"><div align="center" class="STYLE1">姓名</div></td>
        <td width="63" bgcolor="#A6C2DE"><div align="center" class="STYLE1">性别</div></td>
        <td width="50" bgcolor="#A6C2DE"><div align="center" class="STYLE1">年龄</div></td>
        <td width="103" bgcolor="#A6C2DE"><div align="center" class="STYLE1">住址</div></td>
        <td width="118" bgcolor="#A6C2DE"><div align="center" class="STYLE1">所属专业</div></td>
      </tr>
      <?php
