...
<table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#2D5D2B"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
	  ...
	  <tr>
        <td bgcolor="#9ABADA"><div align="center">所在班级:<input type="text" name="classname" size="25" class="inputcss">记录个数:<input type="text" name="number" class="inputcss" size="10">&nbsp;<input type="submit" name="submit" value="查询" class="buttoncss"></div></td>
      </tr>
	  </form>
    </table></td>
  </tr>
...
<table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#256B25"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="97" height="25" bgcolor="#9ABADA"><div align="center" class="STYLE1">学号</div></td>
        ...
        <td width="98" bgcolor="#9ABADA"><div align="center" class="STYLE1">生日</div></td>
        <td width="102" bgcolor="#9ABADA"><div align="center" class="STYLE1">班级</div></td>
      </tr>
	  <?php
	  include_once("conn.php");
	  $number=$_POST[number];
	  $classname=$_POST[classname];
	  $sql=mysql_query("select * from tb_student where classname like '%".$classname."%' order by userid asc limit 0,$number ",$conn);
