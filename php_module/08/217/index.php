  ...
  <tr>
    <td bgcolor="#3497E5"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     <form name="form1" method="post" action="index.php" > 
	  <tr>
        <td bgcolor="#FE9801"><div align="center" class="STYLE1">&nbsp;
...
<table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#3497E5"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="98" height="25" bgcolor="#FE9801"><div align="center">ID</div></td>
        <td width="102" bgcolor="#FE9801"><div align="center">商品名称</div></td>
        <td width="94" bgcolor="#FE9801"><div align="center">单位</div></td>
        <td width="98" bgcolor="#FE9801"><div align="center">单价</div></td>
        <td width="102" bgcolor="#FE9801"><div align="center">数量</div></td>
      </tr>
	 <?php
