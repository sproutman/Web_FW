  ...
  <tr>
    <td bgcolor="#3497E5"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     <form name="form1" method="post" action="index.php" > 
	  <tr>
        <td bgcolor="#CA8B58"><div align="center" class="STYLE1">&nbsp;
...
<table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#3497E5"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="48" height="25" bgcolor="#CA8B58"><div align="center" class="STYLE1">ID</div></td>
        <td width="175" bgcolor="#CA8B58"><div align="center" class="STYLE1">图书名称</div></td>
        <td width="90" bgcolor="#CA8B58"><div align="center" class="STYLE1">作者</div></td>
        <td width="89" bgcolor="#CA8B58"><div align="center" class="STYLE1">库存总量</div></td>
        <td width="92" bgcolor="#CA8B58"><div align="center" class="STYLE1"> 销售总量</div></td>
      </tr>
	 <?php
	 include_once("conn.php");
	 $sql=mysql_query("select *,sum(tb_xs.xssl) as xsl,sum(tb_bk.kcsl) as kcl from tb_bk,tb_xs where tb_bk.id=tb_xs.bookid group by bookname ",$conn); 
	 ...
	 ?>
	  <tr>
        ...
        <td height="25" bgcolor="#FFFFFF"><div align="center"><?php echo $info[kcl];?></div></td>
        <td height="25" bgcolor="#FFFFFF"><div align="center"><?php echo $info[xsl];?></div></td>
      </tr>
	 <?php
