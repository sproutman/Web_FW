  ...
  <tr>
    <td bgcolor="#3497E5"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     <form name="form1" method="post" action="index.php" onsubmit="return chkinput(this)"> 
	  <tr>
        <td bgcolor="#D3E1EC"><div align="center" class="STYLE1"><span class="STYLE2">请输入商品名称</span>:
          &nbsp;
  ...
  <tr>
    <td bgcolor="#3497E5"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        ...
        <td width="94" bgcolor="#D3E1EC"><div align="center">产地</div></td>
        <td width="98" bgcolor="#D3E1EC"><div align="center">型号</div></td>
        <td width="102" bgcolor="#D3E1EC"><div align="center">数量</div></td>
      </tr>
	 <?php
	 $name=$_POST[name];
	 include_once("conn.php");
	 $sql=mysql_query("select distinct * from tb_sp where name like '%".$name."%'",$conn);
