  ...
  <tr>
    <td bgcolor="#679D66"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     <form  name="form1" method="post" action="index.php" onsubmit="return chkinput(this)">
	  <tr>
        <td bgcolor="#8CA6E6"><div align="center">请输入图书名称：
            <input name="bookname" type="text" class="inputcss" id="bookname" size="20">
...
<table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#679D66"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="161" height="25" bgcolor="#8CA6E6"><div align="center" class="STYLE1">书名
          </div>          </td>
        <td width="126" bgcolor="#8CA6E6"><div align="center" class="STYLE1">作者</div></td>
        <td width="99" bgcolor="#8CA6E6"><div align="center" class="STYLE1">出版社</div></td>
        <td width="109" bgcolor="#8CA6E6"><div align="center" class="STYLE1">库存量</div></td>
      </tr>
      <?php
	   ...
	   ?>
      <tr>
        <td height="25" colspan="7" bgcolor="#FFFFFF"><div align="center">没有查找到相关信息!</div></td>
      </tr>
      <?php
		  }
		  else
