  ...
  <tr>
    <td bgcolor="#679D66"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     <form  name="form1" method="post" action="index.php" onsubmit="return chkinput(this)">
	  <tr>
        <td bgcolor="#89CFFE"><div align="center">请输入员工编号：&nbsp;<input type="text" name="bh" size="25" class="inputcss">
  ...
  <tr>
    <td bgcolor="#679D66"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        ...
        <td width="65" bgcolor="#89CFFE"><div align="center" class="STYLE1">员工姓名</div></td>
        <td width="40" bgcolor="#89CFFE"><div align="center" class="STYLE1">员工性别</div></td>
        <td width="44" bgcolor="#89CFFE"><div align="center" class="STYLE1">年龄</div></td>
        <td width="123" bgcolor="#89CFFE"><div align="center" class="STYLE1">联系电话</div></td>
        <td width="85" bgcolor="#89CFFE"><div align="center" class="STYLE1">所属部门</div></td>
        <td width="58" height="25" bgcolor="#89CFFE"><div align="center" class="STYLE1">基本工资</div></td>
      </tr>
      <?php
