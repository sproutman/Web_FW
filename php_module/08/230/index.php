  ...
  <tr>
    <td bgcolor="#3497E5"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     <form name="form1" method="post" action="index.php" > 
	  <tr>
        <td bgcolor="#C1D9F3"><div align="center" class="STYLE1">&nbsp;
            <input type="submit" name="submit" value="合并" class="buttoncss">
        </div></td>
      </tr>
	  </form>
    </table></td>
...
<table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#3497E5"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="128" height="25" bgcolor="#C1D9F3"><div align="center" class="STYLE2">员工ID</div></td>
        <td width="134" bgcolor="#C1D9F3"><div align="center" class="STYLE2">员工姓名</div></td>
        <td width="122" bgcolor="#C1D9F3"><div align="center" class="STYLE3">员工性别</div></td>
        <td width="111" bgcolor="#C1D9F3"><div align="center" class="STYLE2">员工年龄</div></td>
      </tr>
	 <?php
	 ...
	 ?>
	  <tr>
        <td height="25" colspan="5" bgcolor="#FFFFFF"><div align="center">表中无内容!</div></td>
        </tr>
     <?php
	 }
	 else
