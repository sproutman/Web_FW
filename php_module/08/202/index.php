  ...
  <tr>
    <td bgcolor="#DDE2AC"><table width="600" height="25" border="0" cellpadding="0" cellspacing="1">
     <form name="form1" method="post" action="index.php" onsubmit="return chkselect(this)">
	  <tr>
        <td bgcolor="#DAE2AA"><div align="center">查看员工在职情况&nbsp;
          <select name="xz">
...
<?php
 if($_POST[submit]!="")
 {
   ...
   if($xz==1){
    $sqlstr="select * from tb_yg where zz='T'";
   }elseif($xz==2){
    $sqlstr="select * from tb_yg where zz='F'";
   }
...
<table width="600" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#74A39B"><table width="600" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="51" height="25" bgcolor="#DAE2AA"><div align="center">编号</div></td>
        <td width="78" bgcolor="#DAE2AA"><div align="center">员工ID</div></td>
        <td width="90" bgcolor="#DAE2AA"><div align="center">员工姓名</div></td>
        <td width="55" bgcolor="#DAE2AA"><div align="center">性别</div></td>
        <td width="51" bgcolor="#DAE2AA"><div align="center">年龄</div></td>
        <td width="85" bgcolor="#DAE2AA"><div align="center">电话</div></td>
        <td width="117" bgcolor="#DAE2AA"><div align="center">部门</div></td>
        <td width="64" bgcolor="#DAE2AA"><div align="center">是否在职</div></td>
      </tr>
	  <?php
