  ...
  <tr>
    <td bgcolor="#0CA5FF"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     <form  name="form1" method="post" action="index.php" onsubmit="return chkinput(this)">
	  <tr>
        <td bgcolor="#17AAFF"><div align="center">请输入学生学号：
...
<table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#0CA5FF"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="118" height="25" bgcolor="#17AAFF"><div align="center">姓名</div></td>
        <td width="122" bgcolor="#17AAFF"><div align="center">学号</div></td>
        <td width="82" bgcolor="#17AAFF"><div align="center">语文</div></td>
        <td width="86" bgcolor="#17AAFF"><div align="center">外语</div></td>
        <td width="86" bgcolor="#17AAFF"><div align="center">数学</div></td>
      </tr>
	   <?php
	     $sno=$_POST[sno];
