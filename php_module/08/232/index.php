  ...
  <tr>
    <td bgcolor="#0CA5FF"><table width="500" height="25" border="0" align="center" cellpadding="0" cellspacing="1">
     <form  name="form1" method="post" action="index.php">
	  <tr>
        <td bgcolor="#17AAFF"><div align="center">&nbsp;
          <input type="submit" name="submit" value="查询本科以上的员工信息" class="buttoncss">
        </div></td>
      </tr>
	  </form>
    </table></td>
...
<table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td bgcolor="#0CA5FF"><table width="500" height="50" border="0" align="center" cellpadding="0" cellspacing="1">
      <tr>
        <td width="102" height="25" bgcolor="#17AAFF"><div align="center" class="STYLE1">员工编号</div></td>
        <td width="120" bgcolor="#17AAFF"><div align="center" class="STYLE1">员工姓名</div></td>
        <td width="100" bgcolor="#17AAFF"><div align="center" class="STYLE1">所属部门</div></td>
        <td width="86" bgcolor="#17AAFF"><div align="center" class="STYLE1">类别</div></td>
        <td width="86" bgcolor="#17AAFF"><div align="center" class="STYLE1">基本工资</div></td>
      </tr>
	   <?php
