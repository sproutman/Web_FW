<?php
 include("top.php");
?>
<table width="792" height="386" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="386" align="center" valign="top" bgcolor="#F3F2EE"><table width="550" height="15" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td>&nbsp;</td>
      </tr>
    </table>
      <table width="550" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="49" background="images/syt.jpg"><div align="center" style="color: #FFFFFF"></div></td>
        </tr>
        <tr>
		     ...
		     function chkinput(form)
			 {
              ...
              <form name="form1" method="post" action="savedd.php" onSubmit="return chkinput(this)">
                <tr>
                  ...
                  <td width="203" bgcolor="#FFFFFF"><div align="left">
                  ...
                  <td width="66" bgcolor="#FFFFFF"><div align="center">性别：</div></td>
                ...
                <tr>
                  ...
                  <td height="25" colspan="3" bgcolor="#FFFFFF"><div align="left">
                      <input name="dz" type="text" class="inputcss" id="dz" style="background-color:#e8f4ff " onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#e8f4ff'" size="25">
                  </div></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td height="25" colspan="4" bgcolor="#FFFFFF"><div align="center">
                      <input name="submit" type="submit" class="buttoncss" value="提交订单">
                  </div></td>
                </tr>
              </form>
          </table></td>
