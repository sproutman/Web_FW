...
$sql="insert into tb_leaveword (topic,content,createtime,author) values('$txt_topic','$txt_content','$createtime','$_SESSION[username]')";
    ...
    <td height="226" align="center" valign="top" background="images/images_03.gif"><br>
      <form name="form1" method="post" action="">
        <table width="537" border="1" cellpadding="2" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#69C7EF">
          <tr bgcolor="#FFFFFF">
            <td width="147" align="center">主题信息</td>
