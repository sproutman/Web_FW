<?php include "conn/conn.php";$resume=$_GET[resume];?>
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=gb2312">
<link rel="stylesheet" href="css/style.css">
<title>带留言分类的留言本</title>
</head>
...
<table width="805" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<?php
	$sql=mysql_query("select * from tb_leaveword where resume='$resume' order by createtime desc");
